...
export const metadata: Metadata = {
  title: "Procedimentos Faciais | KM Beauty",
  description:
    "Conheca os principais procedimentos faciais da KM Beauty, da harmonizacao ao rejuvenescimento.",
};

export default function ProcedimentosFaciaisPage() {
  return (
    <>
      <Header />
        ...
        <section className="section-padding bg-km-dark text-white">
          <div className="container-km max-w-3xl">
            ...
            <h1 className="mt-4 text-balance text-4xl font-semibold md:text-6xl">
              Rejuvenescimento, contorno e beleza natural com plano personalizado.
            </h1>
            <p className="mt-6 text-base leading-8 text-white/[0.84]">
              Cada indicacao facial parte da avaliacao clinica e do objetivo da
              paciente, combinando tecnica, proporcao e leitura individual de
              rosto.
            </p>
          </div>
        </section>
